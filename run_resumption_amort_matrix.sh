#!/bin/bash
# ============================================================================
# run_resumption_amort_matrix.sh
# Matrice complète rTLS : 1 full → 500 resumed
#
# Matrice:
#   Protocoles : TLS, QUIC
...
LAUNCHER="${SCRIPT_DIR}/Launcherv3_resumption_amort.sh"
DRY_RUN=false
...
echo "=============================================================================="
echo "  rTLS AMORTIZATION MATRIX : 1 Full → 500 Resumed"
